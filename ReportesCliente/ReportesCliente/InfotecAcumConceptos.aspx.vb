...
Partial Class AcumuladoConceptosPersona

    Inherits System.Web.UI.Page

    Public RPT As New InfotecAcumuladoConceptosPersona
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomAcumuladoConceptoEmpleadoMesDescripcion @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNomina = <%IdTipoNomina%>,@Anio = <%Anio%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
        ...
        Try
            ...
            strName = "AcumuladoConceptos" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
