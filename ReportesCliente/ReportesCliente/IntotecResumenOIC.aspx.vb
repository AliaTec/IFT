...
Partial Class ResumenOIC

    Inherits System.Web.UI.Page

    Public RPT As New InfotecResumenOIC
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_OIC_Totales @IdRazonSocial = <%IdRazonSocial%>,@Anio = <%Anio%>,@Mes = <%Mes%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
