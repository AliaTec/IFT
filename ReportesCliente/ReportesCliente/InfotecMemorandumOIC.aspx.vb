...
Partial Class MemorandumOIC

    Inherits System.Web.UI.Page

    Public RPT As New InfotecMemoOIC
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_OIC_Memo_Totales @IdRazonSocial = <%IdRazonSocial%>,@Anio = <%Anio%>,@Mes = <%Mes%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
        ...
        Try
            ...
            strName = "MemorandumOIC" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
