...
Partial Class ICFLiquida

    Inherits System.Web.UI.Page

    Public RPT As New InfotecCFLiquidacion
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_CartaFiniquitoLQ @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
