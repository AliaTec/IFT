...
Partial Class AcumuladoTrimestral

    Inherits System.Web.UI.Page

    Public RPT As New InfotecAcumuladoTrimestral
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_Trimestral @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNomina = <%IdTipoNomina%>,@Anio = <%Anio%>,@Bimestre = <%Bimestre%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
        ...
        RPT.Parameters.Add(ParamIdTipoNomina)
        RPT.Parameters.Add(ParamAnio)
        RPT.Parameters.Add(ParamBimestre)
        ...
        RPT.Parameters("Bimestre").Value = Request.Params("Bimestre")
        ...
        RPT.Parameters("IdTipoNomina").Value = "'" + Request.Params("IdTipoNomina") + "'"
        ...
        Try
            ...
            strName = "AcumuladoTrimestral" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
