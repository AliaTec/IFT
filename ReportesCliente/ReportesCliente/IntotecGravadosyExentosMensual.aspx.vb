...
Partial Class GraExeMensual

    Inherits System.Web.UI.Page

    Public RPT As New InfotecGravadosyExentosMensual
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomGraExenMensual @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNomina = <%IdTipoNomina%>,@Anio = <%Anio%>,@Mes = <%Mes%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
        ...
        Try
            ...
            strName = "GravadosExentosMensual" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
