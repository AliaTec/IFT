...
Public Class InfotecMemoOICDetalleSubReporte2
    ...
    Private Sub Percepciones_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "sp_Reporte_MemoOIC_SubReporte2 @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
    ...
    Private Sub ReportHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs)
