...
Public Class InfotecAcumuladoConceptosPersona
    ...
    Private Sub Percepciones_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomAcumuladoConceptoEmpleadoMesDescripcion @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
