...
Public Class SubMemoOIC5
    ...
    Private Sub SubMemoOIC1_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "sp_Reporte_OIC_Memo_Totales6 @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
