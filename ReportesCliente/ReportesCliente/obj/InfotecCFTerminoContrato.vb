...
Public Class InfotecCFTerminoContrato
    ...
    Public Sub PensionAlimenticia_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
                 sConnection, "sp_Reporte_CartaFiniquitoTC @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
        ...
        Dim SubReportePercepcionesR As New PercepcionesTerminoContrato
        ...
        Dim SubReporteDeduccionesR As New DeduccionesTerminoContrato
